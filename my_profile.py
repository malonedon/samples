...
#software name label
software_name="Gym fitness My profile"
...
CTkLabel(root,text="FULL NAME:{}").pack()
CTkLabel(root,text="WEIGHT:{}").pack()
CTkLabel(root,text="HEIGHT:{}").pack()
CTkLabel(root,text="STAPLE OF FOOD:{}").pack()
CTkLabel(root,text="AMOUNT OF WATER I DRINK PER DAY:{}").pack()
