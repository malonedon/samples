...
#signup  entry
search=CTkEntry(frame,placeholder_text="Search food diat",font=("georgia",20,) ,width=300,corner_radius=50, )
search.pack(pady=10)
CTkButton(frame,text="Search").pack()
...
bicep=PhotoImage(file="categories/execises/bicep.png")
seg.set("Categories")
CTkButton(root,image=bicep,width=50,height=50,text="\nBicep").pack()


heavy_weights_male_female=PhotoImage(file="categories/execises/male_and_female_heavy_weight.png")
CTkButton(root,image=heavy_weights_male_female,width=50,height=50,text="\nHeavy weights {Male/Female}").pack()
